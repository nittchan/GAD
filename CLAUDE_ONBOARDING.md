...
- gad/monitor/triggers.py: Auto-generates 506 triggers across 10 perils from the airport and port registries.
...
- gad/monitor/sources/: API connectors (OpenSky, AviationStack, AirNow, OpenAQ, WAQI, NASA FIRMS, Open-Meteo, GPM IMERG, AISstream, USGS Water Services, NOAA NHC, Copernicus/MODIS NDVI).
